...
| RTX 5090 32GB | 76.9 | 155.5 | 2 | 0.50-0.95 | [@anstaendig](https://github.com/anstaendig) |
...
\* RTX 5090 32GB row: Unsloth Q4_K_M, 131K context, q4_0 KV cache - 19.54GB baseline, 20.38GB with spec.
...
Config: Unsloth UD_Q4_K_XL, Context 262K, Q4_0 KV Cache, MMPROJ loaded, VRAM: ~26GB
| n-max | Overall | P1 code (py) | P2 prose (mmap) | P3 code (bash) | Acceptance |
|---|---|---|---|---|---|
